...
MaterialLinker::MaterialLinker() {
	...
	resource->LoadShader(frauEngine::VS, shaderPathV.c_str());
	resource->LoadShader(frauEngine::PS, shaderPathP.c_str());

	resource->LoadShader(frauEngine::PS, "Data/Shader/PixelShader_Outline.hlsl");

	resource->LoadShader(frauEngine::VS, "Data/Shader/VertexShader_Shadow.hlsl");
	resource->LoadShader(frauEngine::PS, "Data/Shader/PixelShader_Shadow.hlsl");
...
void MaterialLinker::DrawShadow() {
	modelObj.SetAll(Vector3(0, 0, 0), Vector3(-90, 90, 0), Vector3(3, 3, 3));
