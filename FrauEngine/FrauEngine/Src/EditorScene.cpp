...
void EditorScene::Load() {
	...
	frauEngine::Lights::GetInstance()->SetDirectionalLight(Vector3(-5, 8, 0), Vector3(0, 0, 0), Vector3(0, 1, 0), 45, Vector3(1, -1, 1), Vector3(0.5, 0.5, 0.5));
...
void EditorScene::Draw() {
	...
	auto dLight = frauEngine::Lights::GetInstance();
	camera.SetPos(Vector3(0, 0, -12));
	camera.SetTarget(Vector3(0, 0, 0));
	camera.SetUp(Vector3(0, 1, 0));
	camera.SetFov(45);
	...
	lowApp->DrawOnRenderTarget(frauEngine::Application::GetInstance()->GetPostEffectRenderTarget());
